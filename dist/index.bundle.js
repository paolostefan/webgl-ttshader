...
var Raymarcher = /** @class */ (function (_super) {
    ...
    Raymarcher.prototype.createShader = function (type, src) {
        var shader = this.gl.createShader(type);
        this.gl.shaderSource(shader, src);
        this.gl.compileShader(shader);
        if (!this.gl.getShaderParameter(shader, this.gl.COMPILE_STATUS)) {
            var msg = "Cannot create shader\n" + this.gl.getShaderInfoLog(shader);
            this.displayError(msg);
     ...
     * @returns function
     */
    Raymarcher.prototype.updateUniform1f = function (name) {
        var _this = this;
        return function (value) {
            _this.gl.uniform1f(_this.uniformLoc(name), value);
        };
    };
    Raymarcher.prototype.updateUniform2f = function (name) {
        var _this = this;
        return function () {
            _this.gl.uniform2f(_this.uniformLoc(name), _this.parameters[name].x, _this.parameters[name].y);
        };
    };
    Raymarcher.prototype.updateUniform3f = function (name) {
        var _this = this;
        return function () {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _raymarcher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./raymarcher */ "./src/raymarcher.ts");
...
renderer = new _raymarcher__WEBPACK_IMPORTED_MODULE_0__.Raymarcher();
renderer.doTheJob();
