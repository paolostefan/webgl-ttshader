...
var glCapsule = /** @class */ (function () {
    ...
    glCapsule.prototype.updateBooleanUniform = function (name) {
        var _this = this;
        return function (value) {
            _this.gl.uniform1i(_this.uniformLoc(name), !!value ? 1 : 0);
        };
    };
    ...
    // Shortcut
    glCapsule.prototype.drawSceneWithFps = function (milliseconds) {
        this.drawScene(milliseconds);
        this.updateFps(milliseconds);
    };
    glCapsule.prototype.pause = function (p) {
        this.paused = p;
    };
    return glCapsule;
}());
...
/* harmony import */ var _shaders_noise_glsl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shaders/noise.glsl */ "./src/shaders/noise.glsl");
...
var Noise = /** @class */ (function (_super) {
    ...
    function Noise() {
        ...
        _this.parameters = {
            ...
            seed: 839.2121,
            phase: Math.PI,
            speed: 1, // velocità del movimento (unità/secondo)
        };
        return _this;
    }
    Noise.prototype.drawScene = function (milliseconds) {
        var _this = this;
        if (!this.paused) {
        ...
        window.requestAnimationFrame(function (m) {
            _this.drawSceneWithFps(m);
        });
    };
    /**
     * Assegna i valori alle variabili Uniform utilizzate dallo shader
     */
    Noise.prototype.bindUniforms = function (milliseconds) {
        var gl = this.gl;
        gl.uniform1f(this.uniformLoc("u_time"), milliseconds);
        gl.uniform2f(this.uniformLoc("u_mouse"), 0, 0);
        gl.uniform2f(this.uniformLoc("u_resolution"), this.canvas.width, this.canvas.height);
        ...
        gl.uniform1i(this.uniformLoc("u_debug_random"), this.parameters.debugRandom ? 1 : 0);
        gl.uniform1i(this.uniformLoc("u_noise_type"), parseInt(this.parameters.noiseType));
    };
    Noise.prototype.run = function () {
        ...
        var fragmentShader = this.createShader(this.gl.FRAGMENT_SHADER, _shaders_noise_glsl__WEBPACK_IMPORTED_MODULE_2__);
        ...
        this.gl.viewport(0, 0, this.canvas.width, this.canvas.height);
        // Dat.gui
        var gui = new dat_gui__WEBPACK_IMPORTED_MODULE_0__.GUI({ name: "Noise" });
        gui
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _noise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./noise */ "./src/noise.ts");

// Init the renderer var with an instance of a glCapsule implementation
var renderer = new _noise__WEBPACK_IMPORTED_MODULE_0__.Noise();
// Run it 🏍 🏎
renderer.run();
